        ...
        <div class="d-flex justify-content-center h-100">
            <div class="user_card">
                <div class="d-flex justify-content-center">
                    <h4 style="padding-top: 40px; position: absolute;">Students Login</h4>
                </div>
                ...
                <div class="mt-4">
                    <div class="d-flex justify-content-center links text-center">
                        <p s>Don't have an account?<br />Please <span href="" style="fornt-color:#207819;"><a href="students_registration_page.php">Registration</a></span></p>
                    </div>

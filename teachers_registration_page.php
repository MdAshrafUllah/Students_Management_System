...
<body>
        ...
        <div class="d-flex justify-content-center h-100">
            <div class="user_card" style="height: 500px;">
                <div class="d-flex justify-content-center">
                    <h4 style="padding-top: 25px; position: absolute;">Teachers Registration</h4>
                </div>
                <div class="d-flex justify-content-center form_container" style="margin-top: 80px;">
                    <form action="" method="post">
                        <div class="input-group mb-2">
                            <input type="text" name="ts_id" class="form-control input_user" placeholder="Id">
                        </div>
                        <div class="input-group mb-2">
                ...
                <div class="mt-3">
                    <div class="d-flex justify-content-center links text-center">
                        <p>Already Have Account!<br />Please <span href="" style="fornt-color:#207819;"><a href="teacher_login.php">Login</a></span></p>
                    </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO teachers(teachers_id,name,email,password) VALUES('$tsid','$uname','$uemail','$upass')";
